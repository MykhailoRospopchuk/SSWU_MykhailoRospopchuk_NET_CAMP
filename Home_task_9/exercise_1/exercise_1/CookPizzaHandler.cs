...
{
    internal class CookPizzaHandler : BaseCook, ICooKHandler
    {
        ...
        public CookPizzaHandler(DishesType cook_type, List<OneCook> cook)
        {
        ...
        public override void OrderHandle(object request)
        {
            ...
            if (request is IOrder)
            {
                ...
                {
                    View.PrintWithTime($"\t\t____CookPizzaHandler start cooking____Order ID: {current_order.Id}");
