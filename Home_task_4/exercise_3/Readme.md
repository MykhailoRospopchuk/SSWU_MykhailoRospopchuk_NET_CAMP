...
```EnergyRecord``` - клас який, моделює запис. Містить в собі методи і поля для роботи з роботи з конкретним записом по кваратлу.

```EnergyQuarter``` - клас який, моделює квартал. Містить в собі методи і поля для роботи з роботи з конкретним кваратлом.
