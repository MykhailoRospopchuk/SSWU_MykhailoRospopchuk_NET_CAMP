--23. Вивести інформацію про замовлення у форматі: 
--ПІБ клієнта, номер замовлення, марка авто, вартість прокату за добу.
SELECT Client.CName, 
	Orders.OrdersID, 
	Car.Car_model, 
	Car.Price_per_day 
...
--24. Вивести інформацію про пари замовлень одного клієнта у форматі: 
--номер клієнта, дата початку прокату та номер авто № 1, дата початку прокату та номер авто № 2.
SELECT O1.ClientID,
...
--25. Вивести інформацію про замовлення у форматі: 
--номер клієнта, ПІБ клієнта, максимальна ціна за добу його замовлення.
...
--26. Вивести статистику у форматі: 
--номер авто, номер клієнта, кількість замовлень на цю машину у клієнта
SELECT Orders.CarID, 
	Orders.ClientID, 
...
--27. Для кожної дати порахувати кількість замовлень у цей день, 
--та вивести, якщо кількість більша або дорівнює 2. 
--Вивести у форматі: дата початку прокату, кількість замовлень
...
--28. Для кожної машини знайти сумарний пробіг за всі оренди та вивести, 
--якщо ця кількість більша за 5000 км.
...
--29. Вивести інформацію про замовлення у форматі: 
--номер замовлення, номер та ПІБ клієнта, дата початку замовлення, сума пошкоджень; 
--вивести, якщо сума більша за 2000.
...
--30. Вивести інформацію про замовлення клієнтів з Києва у форматі: 
--ПІБ клієнта, номер замовлення, кількість днів замовлення, сумарна вартість замовлення; 
--вивести, якщо сума більша за 1000.
