...
{
    internal class CookDessertsHandler : BaseCook, ICooKHandler
    {
        public delegate void AskNewOrderDelegate();

        public event AskNewOrderDelegate? AskOrder;
        ...
        public CookDessertsHandler(DishesType cook_type, List<OneCook> cook)
        {
        ...
        {
            //View.PrintWithTime("\t\t____CookDessertsHandler start cooking____");
            ...
            if (request is IOrder)
            {
                ...
                {
                    View.PrintWithTime($"\t\t____CookDessertsHandler start cooking____Order ID: {current_order.Id}");
